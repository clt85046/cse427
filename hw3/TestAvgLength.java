...
public class TestAvgLength {
  ...
  public void testReducer() {
	  ...
	  reduceDriver.withOutput(new Text("c"),new DoubleWritable(2.5));
	  System.out.println("Success");
	  reduceDriver.runTest();
	  //if(reduceDriver.runTest())
	  //{
		//  System.out.println("Success");
	  //}
  ...
  public void testMapReduce() {
    ...
    //fail("Please implement test.");
	  ...
	  mapReduceDriver.withOutput(new Text("c"),new DoubleWritable(3.0));
